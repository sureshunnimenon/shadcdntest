...
export default async function Home() {
  return (
    <>
      <Landingnav />
      <Landinghero />
      <h3 className="text-white tracking-wider text-[10px] md:text-[12px] lg:text-[14px] font-extrabold opacity-90 bg-amber-700 flex items-center pt-6 px-9 pb-9">
        <span className="italic bold text-yellow-500">The LOGO:</span>The circle
      ...
      <Landingvideo />
      <h3 className="text-white tracking-wider text-[10px] md:text-[12px] lg:text-[14px] font-extrabold opacity-90 bg-amber-700 flex items-center pt-6 px-9 pb-9">
        <span className="italic bold text-yellow-500 pr-3">OM:</span>
      ...
      <ul className="text-white  text-[8px] md:text-[10px] lg:text-[14px] opacity-70 px-24 py-3 font-bold italic">
        <li>
          The circle: The circle is a universal symbol of wholeness and unity.
          It represents the interconnectedness of all things in the universe. In
          Hinduism, the circle is also a symbol of the soul.
        </li>
        <br />
        <li>
          The word "OM": The word "OM" is a sacred syllable in Hinduism. It is
          said to represent the universe and the three states of consciousness:
          waking, dreaming, and deep sleep.
        </li>
        <br />
        <li>
          The lotus flower: The lotus flower is a symbol of purity and
        ...
        <br />
        <li>
          The lamp: The lamp is a symbol of knowledge and wisdom in Hinduism. It
          represents the light of truth that dispels the darkness of ignorance.
        </li>
        <br />
        <li>
          The bell: The bell is a symbol of peace and harmony in Hinduism. It is
